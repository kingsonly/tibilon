...
//           <p><span className="font-bold">Address:</span> 6 Julius Berger Estate</p>
...
//         <tr className="font-bold border-b-6 h-[50px] bg-slate-50">    
...
//         <tr className="border-b-6 h-[50px]">    
