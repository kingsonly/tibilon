...
class PropertyController extends Controller
{
     ...
     * @group Properties
     *
     * Get a list of properties for a specific project.
     *
     * @queryParam id required The ID of the project.
     * @queryParam page The page number (default: 1).
     * @queryParam per_page The number of results per page (default: 10).
     *
     * @response {
     *    "status": "success",
     *    "data": [
     ...
     *
     * @bodyParam project int required The ID of the project.
     * @bodyParam name string required The name of the property.
     * @bodyParam image file required The cover image of the property.
     * @bodyParam description string required The description of the property.
     * @bodyParam amenities json required An array of amenities with their quantities.
     * @bodyParam amount decimal required The amount of the property.
     *
     * @response {
     *    "status": "success",
     ...
     *
     * @urlParam id string required The ID of the property.
     *
     * @response {
     *     "id": 1,
     *     "project": {
     ...
     *
     * @bodyParam name string required The name of the property.
     * @bodyParam image file required The image of the property.
     * @bodyParam description string required The description of the property.
     *
     * @response 200 {
     *     "status": "success",
     ...
     * Delete a property.
     *
     * @urlParam id string required The ID of the property to delete.
     *
     * @response 200 {
     *     "status": "success",
     ...
     *
     * @queryParam query string required The search query to filter properties by name or description.
     * @queryParam page int The page number (default is 1).
     * @queryParam perpage int The number of properties to show per page (default is 10).
     *
     * @response 200 {
     *     "status": "success",
     *     "data": [
     ...
     * @group Properties
     *
     * View a property payment by ID.
     *
     * @urlParam id integer required The ID of the property payment.
     *
     * @response 200 {
     *     "status": "success",
     *     "data": {
     ...
     * @queryParam per_page integer The number of payments per page.
     * @queryParam page integer The page number for paginated results.
     *
     * @response 200 {
     *     "status": "success",
     *     "data": [
     ...
     * @group Payments
     *
     * Add a payment for a property.
     *
     * @bodyParam property integer required The ID of the property.
     * @bodyParam proofOfPayment file required Proof of payment image.
     * @bodyParam amount float required The payment amount.
     * @bodyParam modeOfPayment string required The mode of payment.
     *
     * @response 201 {
     *     "status": "success",
     *     "data": {
     ...
     * @group Properties
     *
     * Get the client associated with a property.
     *
     * @urlParam id integer required The ID of the property.
     *
     * @response 200 {
     ...
     * @group Properties
     *
     * Update a property's amenity.
     *
     * @urlParam id integer required The ID of the property amenity.
     *
     * @bodyParam amenity integer required The ID of the amenity.
     * @bodyParam quantity integer required The quantity of the amenity.
     *
     * @response 201 {
     *     "status": "success"
     * }
     ...
     * @group Properties
     *
     * Get the agent associated with a specific property.
     *
     * @urlParam id integer required The ID of the property.
     *
     * @response 200 {
     ...
     * @group Properties
     *
     * Record agent commission payment for a specific property.
     *
     * @urlParam id integer required The ID of the property.
     *
     * @bodyParam amount float required The commission amount.
     * @bodyParam modeOfPayment string required The payment mode (e.g., "Bank Transfer").
     *
     * @response 200 {
     *     "status": "success"
     * }
     ...
     * @group Properties
     *
     * Generate a payment receipt for a specific property.
     *
     * @urlParam id integer required The ID of the payment receipt.
     *
     * @response 200 {
